...
class DroidTheme {
  ...
  // ── Accent Colors (CachyOS Emerald Theme) ──
  static const Color primary = Color(0xFF00F076);      // CachyOS Emerald
  static const Color primaryLight = Color(0xFF5FFFA6);
  static const Color secondary = Color(0xFF00C8B3);     // Cyan Teal
  static const Color accent = Color(0xFF00C8B3);         // Emerald
  static const Color warning = Color(0xFFF59E0B);        // Amber
  static const Color error = Color(0xFFEF4444);          // Red
  static const Color success = Color(0xFF00F076);        // Green

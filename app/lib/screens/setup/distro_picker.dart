                ...
                Expanded(
                  child: ListView(
                    children: [
                      _DistroCard(
                        id: 'cachyos',
                        name: 'CachyOS (Arch ARM64)',
                        description: 'Ultra-fast Arch Linux base with stunning Emerald styling & Maleoon GPU optimizations.',
                        size: '~450 MB download',
                        color: const Color(0xFF00F076),
                        icon: Icons.flash_on_rounded,
                        recommended: true,
                        selected: state.selectedDistro == 'cachyos',
                        onTap: () => state.setSelectedDistro('cachyos'),
                      ),
                      const SizedBox(height: 12),
                      _DistroCard(
                        id: 'ubuntu',
                        name: 'Ubuntu 24.04 LTS',
                        description: 'Huge package library, great general community support.',
